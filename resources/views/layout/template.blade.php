  ...
  <nav class="navbar navbar-dark bg-dark fixed-top">
    <div class="container-fluid">
      <a class="row navbar-brand" href="#">
        <i class="col ri-compass-3-line" style="font-size: 23px"></i>
        <span class="col"><strong>Camp Rent</strong></span>
      </a>
      ...
      <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
        <div class="offcanvas-body">
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            <li>
              <h4 class="text-center">CAMP-RENT</h4>
            </li>
            <li>
              <hr class="mb-0">
            </li>
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12 text-center">
                <p class="text-secondary">Copyright camp-rent © 2023. All rights reserved.</p>
              </div>
            </div>
          </div>
        </div>
