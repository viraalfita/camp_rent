...
<div class="card mt-5 bg-dark shadow-sm">
    ...
    <div class="my-3 p-3 bg-dark">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" name='alamat' id="alamat" rows="3" {{Session::get('alamat')}}></textarea>
            </div>
        </div>
        <div class="mb-4 row">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="date" class="form-control" name='tgl_sewa' id="tgl_sewa" value="{{Session::get('tgl_sewa')}}">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="tgl_kembali" class="col-sm-2 col-form-label text-light">Tanggal Kembali</label>
            <div class="col-sm-10">
                <input type="date" class="form-control" name='tgl_kembali' id="tgl_kembali" value="{{Session::get('tgl_kembali')}}">
            </div>
        </div>
        <div class="mb-4 row">
            ...
            <div class="col-sm-10">
                <select class="form-control" multiple name='barang[]' id="barang">
                    ...
                    <option value="{{$dat->id}}">{{$dat->nama_barang}}</option>
                    @endforeach
                </select>
            </div>
        </div>
